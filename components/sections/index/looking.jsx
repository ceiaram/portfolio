  ...
  return (
    <Section classProp={`${looking.section} borderBottom`}>
      ...
      >
        ...
        <h2 className={looking.json}>EntryLevel : &#123;</h2>
        <h2 className={looking.jsonSub}>
          <span className={looking.highlight}>Software Developer</span>,
        </h2>
        <h2 className={looking.jsonSub}>
          <span className={looking.highlight2}>Full Stack Web Developer</span>,
        </h2>
        <h2 className={looking.jsonSub}>
          <span className={looking.highlight3}>Backend Developer</span>
        </h2>
